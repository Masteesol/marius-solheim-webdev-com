...
function createTabs() {
  ...
  const textContainer = createElement(
    "div",
    ["border", "p-3", "border-2", "border-top-1"],
    "style | id",
    "background-color: rgb(0, 0, 0, 0.8); | tabs-text"
  );
  ...
  array.forEach((item, index) => {
    if (index != 0) {
      modifyClassNames(item, "border-transparent", [
        "border-light",
        "bg-black",
        "active",
      ]);
    ...
    item.addEventListener("click", function () {
      ...
      body.addEventListener("click", function (event) {
        ...
        if (event.target.classList.contains("quick-view")) {
          ...
          for (const button of buttons) {
            modifyClassNames(button, "btn-primary", [
              "btn-secondary",
              "active",
            ]);
          }
        ...
        switch (event.target.id) {
          case "projects-tab":
            ...
            modifySite(
              url,
              pageUrl,
              semesterProject.heading,
              semesterProject.subheading,
              semesterProject.about,
              urlMobile
            );
            break;
          ...
          case "project-exam-1":
            ...
            modifySite(
              url,
              pageUrl,
              projectExamOne.heading,
              projectExamOne.subheading,
              projectExamOne.about,
              urlMobile
            );
            break;
      ...
      function modifySite(
        ...
        const paragraph = createElement(
          "p",
          ["about-page", "position-absolute"],
          "style",
          "max-width: 600px; max-height: 9rem; overflow-y: auto"
        );
        paragraph.innerText = about;
        const visitBtn = createElement(
          "a",
          [
            "btn",
            "btn-primary",
          ...
          ["href", "target", "style"],
          [pageUrl, "_blank", "right: 0px; font-size: 1.5rem"],
          "Visit Website"
        );
        const containerVisitBtn = createElement(
          "div",
          "w-100 position-absolute",
          "style | id",
          "top: 0 | visit-page-btn"
        );
        ...
        layerTwo.setAttribute(
          "style",
          `background: rgba(0, 0, 0, 0.5) url(${ImageUrl}); background-size: cover; background-position: center; background-blend-mode: darken`
        );
  ...
  const container = createElement(
    "div",
    ["tabs", "px-0", "container", "ms-0", "pt-5"],
    "style",
    "height: 20rem; max-width: 600px"
  );
...
const triangleUtilities = {
  base: ["triangle"],
  size: ["triangle-small", "triangle-medium", "triangle-large"],
  direction: [
    "move-up-right",
    "move-up-right-2",
    "move-up-right-3",
  ...
  duration: ["duration-fast", "duration-medium", "duration-slow"],
};
